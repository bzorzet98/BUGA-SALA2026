...
# This transformation is necessary for train the ResNet18 due to ImageNet
...
############################## SPLIT INTO DATA TRAIN, VALIDATION and TEST ####################
# data_train = 
...
model.fc = nn.Identity() # This is necessary for keep the embeddings before the linear layer
model.to(device)
