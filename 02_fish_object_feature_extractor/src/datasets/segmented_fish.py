...
class FishDataset(Dataset):
    def __init__(self, root_dir = None, transform=None, sub_folder=None):
        ...
        self.labels_dir = os.path.join(root_dir, 'labels', sub_folder) if sub_folder is not None else os.path.join(root_dir, 'images')
        self.transform = transform if transform is not None else ImageNetDefaultTransforms
        
        # List all files and ensure there is a correspondence between images and labels
